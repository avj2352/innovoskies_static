...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['0px','-2px','100%','600px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/blue_strip.png','0px','0px']
   },
   {
      id:'loader-bar',
      type:'image',
      tag:'img',
      rect:['42.5%','543px','174px','19px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/loader-bar.gif','0px','0px']
   },
   {
      id:'Text',
      type:'text',
      rect:['46.3%','518px','86px','28px','auto','auto'],
      text:"Loading",
...
dlContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['0','0','1080px','600px','auto','auto'],
